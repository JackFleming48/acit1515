import sys # DO NOT REMOVE, needed for question 2, part c
...
def choose(prov):
    ...
    if user_input.isalpha() or int(user_input) > len(provinces):    # if input is string, or greater than length of provinces list
